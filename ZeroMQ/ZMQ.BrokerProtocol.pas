...
begin
  ...
  begin
    ...
    if Assigned(FBroker.OnLogMessage) then
      FBroker.OnLogMessage(Self, Format('Added worker %s', [AWorkerId]));
  end;
...
begin
  ...
  begin
    ...
    if Assigned(FBroker.OnLogMessage) then
      FBroker.OnLogMessage(Self, Format('Added service %s', [AName]));
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Result := True;
      if Assigned(FBroker.OnLogMessage) then
        FBroker.OnLogMessage(Self, Format('Added worker to service %s - %s', [AName, AWorkerId]));
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Result := True;
      if Assigned(FBroker.OnLogMessage) then
        FBroker.OnLogMessage(Self, Format('Deleted worker from service %s - %s', [AName, AWorkerId]));
    end;
  end;
end;
